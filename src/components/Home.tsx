    ...
    <section id="Home" className="h-full w-full">
      ...
      <div className="flex min-h-[90vh] w-full flex-col items-center justify-center px-3 lg:px-0">
        <div className="w-fit px-4">
          ...
          <div className="py-1 font-raleway text-4xl text-gray-800 sm:text-6xl md:text-7xl lg:text-8xl">
          ...
          <div className="max-w-xl pt-3 font-raleway text-sm font-medium leading-relaxed text-gray-500">
            I'm a student at SRM University AP, Amaravathi. I enjoy building
            things that live on the internet. I love to learn about new
            technologies and work on projects that solve real-world problems.
          </div>
          <div className="block lg:hidden">
            <div className="flex space-x-6 py-8">
              <div>
                <a href="https://twitter.com/sashank_123" target="_blank">
                  <svg
                    ...
                    height="16"
                    fill="currentColor"
                    className="h-6 w-6 text-gray-600 hover:text-sky-500"
                    viewBox="0 0 16 16"
                  >
              ...
              <div>
                <a href="https://github.com/sakkurthi-sashank" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
              ...
              <div>
                <a
                  href="https://www.instagram.com/sashank7900/"
                  target="_blank"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    height="16"
                    fill="currentColor"
                    className="h-6 w-6 text-gray-600 hover:text-pink-500"
                    viewBox="0 0 16 16"
                  >
